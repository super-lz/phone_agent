...
- 文件、数据库、记忆、Workspace、Artifact、Office/PDF 文档、时间、定位、剪贴板、相机、媒体选择、系统文件选择、麦克风录音、联系人选择、二维码/条码识别、通知、日历、设备信息、屏幕指标读取、屏幕常亮与方向控制、系统音量控制、系统 UI 显隐控制、WebView、Skill 和 MCP 的 Capability 定义。
- Artifact 中心。
- 全局长期记忆和会话上下文。

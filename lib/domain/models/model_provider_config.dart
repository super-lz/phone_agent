...
class ModelProviders {
  ...
  static final xiaomiMimo = ModelProviderConfig(
    ...
    group: ModelProviderGroup.domestic,
    baseUrl: Uri.parse('https://platform.xiaomimimo.com/'),
    apiProtocol: ModelApiProtocol.unavailable,
    defaultModel: 'mimo-v2.5-pro',
    modelOptions: const [
      ModelOption(name: 'mimo-v2.5-pro'),
      ModelOption(name: 'mimo-v2.5'),
      ModelOption(name: 'mimo-v2.5-tts'),
      ModelOption(name: 'mimo-v2.5-asr'),
    ],
    supportsTools: false,
    model: 'mimo-v2.5-pro',
    defaultParameters: const {},
    apiKeyHelpUrl: Uri.parse('https://mimo.mi.com/'),
    documentationUrl: Uri.parse('https://mimo.xiaomi.com/'),
  );

...
class ModelProviders {
  ...
  static final moonshotKimi = ModelProviderConfig(
    ...
    group: ModelProviderGroup.domestic,
    baseUrl: Uri.parse('https://api.moonshot.cn/v1/'),
    apiProtocol: ModelApiProtocol.openAiChatCompletions,
    ...
    model: 'kimi-k2.6',
    defaultParameters: const {},
    apiKeyHelpUrl: Uri.parse('https://platform.kimi.com/console'),
    documentationUrl: Uri.parse(
  ...
  static final miniMax = ModelProviderConfig(
    ...
    modelOptions: const [
      ModelOption(name: 'MiniMax-M3', maxContextTokens: 1000000),
      ModelOption(name: 'MiniMax-M2.7', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2.7-highspeed', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2.5', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2.5-highspeed', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2.1', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2.1-highspeed', maxContextTokens: 204800),
      ModelOption(name: 'MiniMax-M2', maxContextTokens: 204800),
    ],
    supportsTools: true,
    model: 'MiniMax-M3',
    defaultParameters: const {},
  ...
  static final openAi = ModelProviderConfig(
    ...
    modelOptions: const [
      ModelOption(name: 'gpt-5.5', maxContextTokens: 1000000),
      ModelOption(name: 'gpt-5.4', maxContextTokens: 1000000),
      ModelOption(name: 'gpt-5.4-mini', maxContextTokens: 400000),
  ...
  static final anthropicClaude = ModelProviderConfig(
    ...
    modelOptions: const [
      ModelOption(name: 'claude-opus-4-8', maxContextTokens: 1000000),
      ModelOption(name: 'claude-sonnet-4-6', maxContextTokens: 1000000),
      ModelOption(name: 'claude-haiku-4-5', maxContextTokens: 200000),
    ],
    supportsTools: false,
